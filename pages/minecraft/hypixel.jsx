...
function Hypixel() {  
    ...
    return (
        ...
        <div
            className="bg-gray-800 rounded-lg max-w-xl w-full h-64 p-7 flex flex-row mt-6"
        >
            <div className="bg-gray-700 h-full rounded-lg mr-9" style={{aspectRatio: "1/1"}}>
            <img
            ...
            <span className="text-sm flex items-center"
                >Status: <div
                className={`h-3 w-3 rounded-full ml-2 ${data?.status === false
                    ? 'bg-red-500'
                    : 'bg-green-500'}`}
                /></span
            >
            <span className="text-sm"
                >Rank: <span className="font-normal">
                {data?.rank
            ...
            >
            <span className="text-sm"
                >Guild: <span className="font-normal"
                >{data?.guild ? data.guild : "No Guild"}</span
                ></span
            >
            </div>
        </div>
